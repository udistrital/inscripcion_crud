...
// @Param	body		body 	models.EstadoEntrevista	true		"body for EstadoEntrevista content"
// @Success 201 {int} models.EstadoEntrevista
// @Failure 403 body is empty
// @router / [post]
func (c *EstadoEntrevistaController) Post() {
	var v models.EstadoEntrevista
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddEstadoEntrevista(&v); err == nil {
...
// @Success 200 {object} models.EstadoEntrevista
// @Failure 403 :id is empty
// @router /:id [get]
func (c *EstadoEntrevistaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetEstadoEntrevistaById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *EstadoEntrevistaController) GetAll() {
	...
	l, err := models.GetAllEstadoEntrevista(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *EstadoEntrevistaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.EstadoEntrevista{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateEstadoEntrevistaById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
func (c *EstadoEntrevistaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteEstadoEntrevista(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
