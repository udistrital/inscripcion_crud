...
import (
	...
	"github.com/udistrital/inscripciones_crud/inscripcion_crud/models"
...
// @Param	body		body 	models.CupoInscripcion	true		"body for CupoInscripcioncontent"
...
func (c *CupoInscripcionController) Put() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if get, errGet := models.GetCupoInscripcionById(id); errGet == nil {
