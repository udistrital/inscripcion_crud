...
// @Param	body		body 	models.Entrevista	true		"body for Entrevista content"
// @Success 201 {int} models.Entrevista
// @Failure 403 body is empty
// @router / [post]
func (c *EntrevistaController) Post() {
	var v models.Entrevista
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddEntrevista(&v); err == nil {
...
// @Success 200 {object} models.Entrevista
// @Failure 403 :id is empty
// @router /:id [get]
func (c *EntrevistaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetEntrevistaById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *EntrevistaController) GetAll() {
	...
	l, err := models.GetAllEntrevista(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *EntrevistaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Entrevista{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateEntrevistaById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
func (c *EntrevistaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteEntrevista(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
