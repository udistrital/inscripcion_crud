...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/admisiones_crud/controllers:EnfasisProyectoController"] = append(beego.GlobalControllerRouter["github.com/udistrital/admisiones_crud/controllers:EnfasisProyectoController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
